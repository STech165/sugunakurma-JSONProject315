...
//
//  Created by Suguna Kurma on 10/15/23.
...
class ViewController: UIViewController {
    ...
    var SplitViewFC: Fitness = Fitness()
    ...
    @IBOutlet weak var txtbenefits: UITextView!
    @IBOutlet weak var txtitems: UITextView!
    @IBOutlet weak var lblname: UILabel!
    @IBOutlet weak var imgfood: UIImageView!
    @IBOutlet weak var txtadvisory: UITextView!
    
    var HealthPageArray = [Fitness]()
    
    var randompage = Fitness()
    
    var soundfile: AVAudioPlayer!
    
    @IBAction func lblnextpage(_ sender: Any) {
    ...
    @IBAction func btnsite(_ sender: Any) {
        let websiteApp = UIApplication.shared
        
        let url = URL(string: randompage.FoodSite)
        websiteApp.open(url!)
        
    }
    
    func setLabels () {
       // randompage = HealthPageArray.randomElement()!
        
        var randompage = SplitViewFC;
        lblwelcome.text = randompage.FoodName
        txtdescription.text = randompage.FoodDescription
        lbltime.text = randompage.FoodTime
        txtbenefits.text = randompage.FoodBenefits
        txtitems.text = randompage.FoodIngrediants
        lblname.text = randompage.NameTitle
        txtadvisory.text = randompage.Advisory
        
        
        imgfood.image = UIImage(named: randompage.FoodImage)
        imgfood.layer.cornerRadius = 17
        imgfood.layer.borderColor = UIColor.darkGray.cgColor
        imgfood.layer.borderWidth = 3
        imgfood.contentMode = .scaleAspectFill
        
        txtdescription.layer.cornerRadius = 14
        txtdescription.layer.borderColor = UIColor.darkGray.cgColor
        txtdescription.layer.borderWidth = 2
        txtdescription.contentMode = .scaleAspectFill
        
        txtbenefits.layer.cornerRadius = 14
        txtbenefits.layer.borderColor = UIColor.darkGray.cgColor
        txtbenefits.layer.borderWidth = 2
        txtbenefits.contentMode = .scaleAspectFill
        
        txtitems.layer.cornerRadius = 14
        txtitems.layer.borderColor = UIColor.darkGray.cgColor
        txtitems.layer.borderWidth = 2
        txtitems.contentMode = .scaleAspectFill
        
        txtadvisory.layer.cornerRadius = 14
        txtadvisory.layer.borderColor = UIColor.darkGray.cgColor
        txtadvisory.layer.borderWidth = 2
        txtadvisory.contentMode = .scaleAspectFill
    ...
    override func motionEnded(_ motion: UIEvent.EventSubtype, with event: UIEvent?) {
        UIView.animate(withDuration: 3, animations: {
            ...
            self.txtbenefits.alpha = 1
            self.txtitems.alpha = 1
    ...
    override func viewDidLoad() {
        ...
        let soundurl = URL(fileURLWithPath:
                            Bundle.main.path(forResource:"sound", ofType: "mp3")!)
